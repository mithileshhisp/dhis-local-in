...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template match="d:resources|d:maps|d:mapViews|d:charts|d:categoryCombos|d:categories|
	  ...
	  d:equipments|d:equipmentTypes|d:equipmentStatusSet|
	  d:equipmentTypeAttributes|d:equipmentTypeAttributeGroups|d:models|d:modelTypes|d:modelTypeAttributes|d:modelTypeAttributeGroups">
