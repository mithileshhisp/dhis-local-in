...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:include href="equipmentStatusSet.xsl" />
  <xsl:include href="equipmentTypeAttribute.xsl" />
  <xsl:include href="equipmentTypeAttributeGroup.xsl" />
  <xsl:include href="model.xsl" />  
  <xsl:include href="modelType.xsl" /> 	 
  <xsl:include href="modelTypeAttribute.xsl" />  
  <xsl:include href="modelTypeAttributeGroup.xsl" />
