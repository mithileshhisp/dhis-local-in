...
public class HibernateEquipmentTypeStore
    extends HibernateIdentifiableObjectStore<EquipmentType>
    implements EquipmentTypeStore
{
    // -------------------------------------------------------------------------
    // Dependencies
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    /*
     * @Override public int addEquipmentType( EquipmentType equipmentType ) {
     * Session session = sessionFactory.getCurrentSession();
     * 
     * return (Integer) session.save( equipmentType ); }
     * 
     * @Override public void deleteEquipmentType( EquipmentType equipmentType )
     * { Session session = sessionFactory.getCurrentSession();
     * 
     * session.delete( equipmentType ); }
     * 
     * @Override public Collection<EquipmentType> getAllEquipmentTypes() {
     * Session session = sessionFactory.getCurrentSession();
     * 
     * return session.createCriteria( EquipmentType.class ).list(); }
     * 
     * @Override public void updateEquipmentType( EquipmentType equipmentType )
     * { Session session = sessionFactory.getCurrentSession();
     * 
     * session.update( equipmentType ); }
     * 
     * public EquipmentType getEquipmentTypeByName( String name ) { Session
     ...
     * 
     * public EquipmentType getEquipmentType( int id ) { Session session =
     ...
     * Collection<EquipmentTypeAttribute>
     * getAllEquipmentTypeAttributesForDisplay( EquipmentType equipmentType ) {
     * Criteria criteria = sessionFactory.getCurrentSession().createCriteria(
     * EquipmentTypeAttribute.class ); criteria.setProjection(
     * Projections.property( "display" ) ); return criteria.list(); }
     */
    @Override
    public EquipmentType getEquipmentType( String uuid )
    {
        return (EquipmentType) sessionFactory.getCurrentSession().get( EquipmentType.class, uuid );
    }
