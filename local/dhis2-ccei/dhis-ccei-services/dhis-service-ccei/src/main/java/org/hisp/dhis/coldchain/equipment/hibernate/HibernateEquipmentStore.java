...
public class HibernateEquipmentStore 
    extends HibernateIdentifiableObjectStore<Equipment>
    implements EquipmentStore
{
    ...
    */
    ...
    public Collection<Equipment> getEquipments( OrganisationUnit orgUnit, EquipmentType equipmentType, String equipmentTrackingID )
    {
        ...
        con.add( Restrictions.eq( "organisationUnit", orgUnit ) );
        con.add( Restrictions.eq( "equipmentType", equipmentType ) );
        con.add( Restrictions.eq( "equipmentTrackingID", equipmentTrackingID ) );
    ...
    public Collection<Equipment> getEquipmentsByStatus( String cws )
    {
        ...
        conjunction.add( Restrictions.eq( "cws", cws ) );
    ...
    public Collection<Equipment> getEquipmentsByStatus( EquipmentType equipmentType, String cws )
    {
        ...
        conjunction.add( Restrictions.eq( "equipmentType", equipmentType ) );
        conjunction.add( Restrictions.eq( "cws", cws ) );
