    ...
    implements CCEMReportManager
{
    ...
    public Map<String, String> getDataValueMapForRequirement( String orgUnitIdsByComma, String dataelementIds, Integer periodId )
    {
        Map<String, String> dataElementDataForRequirement = new HashMap<String, String>();
        try
        {
            String query = "SELECT dataelementid, sourceid, value FROM datavalue " + " WHERE "
                           + " dataelementid IN ( " + dataelementIds + ") AND " + " sourceid IN ( "
            ...
            while ( rs.next() )
            {
                ...
                //System.out.println("********DE : " + deId +  ":" + sourceId + " : " + value );
                dataElementDataForRequirement.put( sourceId + ":" + deId, value );
            }
        }
        catch ( Exception e )
        {
        ...
        Integer modelTypeAttributeId, Integer yearInvTypeAttId, Integer ageStart, Integer ageEnd )
    {
        ...
        try
        {
            ...
            if ( dataBaseInfo.getType().equalsIgnoreCase( "mysql" ) )
            {
                ...
                query += " equipment.organisationunitid IN ( " + orgUnitIdsByComma + " ) AND  equipmentattributevalue.value not like ''  "
