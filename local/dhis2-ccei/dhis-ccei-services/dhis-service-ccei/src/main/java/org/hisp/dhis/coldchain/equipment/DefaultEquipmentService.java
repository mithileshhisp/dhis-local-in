...
public class DefaultEquipmentService implements EquipmentService
{
    ...
    public Equipment getEquipment( String uid )
    {
        return equipmentStore.getByUid(uid) ;
    }
    ...
    public Collection<Equipment> getEquipments( OrganisationUnit orgUnit, EquipmentType equipmentType, String equipmentTrackingID )
    {
    	return equipmentStore.getEquipments( orgUnit, equipmentType, equipmentTrackingID );
    }
    
    
    public Collection<Equipment> getEquipmentsByStatus( String cws )
    {
        return equipmentStore.getEquipmentsByStatus( cws );
    }
    
    
    public Collection<Equipment> getEquipmentsByStatus( EquipmentType equipmentType, String cws )
    {
        return equipmentStore.getEquipmentsByStatus( equipmentType, cws );
    }
