...
public class EquipmentAttributeValue implements Serializable
{
    ...
    public static final String FACILITY_MANAGEMENT_DATA_SET_NAME = "Facility Management Dataset";
    
    public static final String FACILITY_MANAGEMENT_DATA_SET_SHORT_NAME = "FMD";
