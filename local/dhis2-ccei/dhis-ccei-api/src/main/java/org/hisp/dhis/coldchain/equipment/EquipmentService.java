...
public interface EquipmentService
{
    ...
    Equipment getEquipment( String uid );
    ...
    Collection<Equipment> getEquipments( OrganisationUnit orgUnit, EquipmentType equipmentType, String equipmentTrackingID );
    
    Collection<Equipment> getEquipmentsByStatus( String cws );
    
    Collection<Equipment> getEquipmentsByStatus( EquipmentType equipmentType, String cws );
