...
public class AddEquipmentAction implements Action
{
    ...
    */
    ...
    public String execute()
    {
        ...
        try
        {
            Date regDate = simpleDateFormat.parse( registrationDate );
            equipment.setRegistrationDate( regDate );
        }
        catch( Exception e )
        {
            ...
            if ( StringUtils.isNotBlank( value ) )
            {
                ...
                if ( EquipmentTypeAttribute.TYPE_COMBO.equalsIgnoreCase( attribute.getValueType() ) )
                {
                    ...
                    if ( EquipmentStatus.WORKING_STATUS.equalsIgnoreCase( attribute.getDescription() ) )
                    {
                        ...
                        else if( EquipmentStatus.STATUS_WORKING_NEEDS_MAINTENANCE.equalsIgnoreCase( value ) ) 
                        {
                            equipment.setWorking( false );
                            equipment.setCws( EquipmentStatus.STATUS_WORKING_NEEDS_MAINTENANCE.trim() );
                        }
                        else if( EquipmentStatus.STATUS_WORKING_WELL.equalsIgnoreCase( value ) ) 
                        {
