...
*/
        ...
        EquipmentStatus equipmentStatus = equipmentStatusService.getEquipmentStatusByReportingDate( equipment, period.getEndDate() );
        ...
        if( equipmentStatus == null )
        {
            ...
            equipmentStatus.setDescription( "save datavalue action" );
            equipmentStatus.setReportingDate( period.getEndDate() );
            equipmentStatus.setUpdationDate( period.getEndDate() );
