 ...
 */
public class GenerateCCEIReportAction
    implements Action
{
     ...
     * 
     * public void setOwnership( String[] ownership ) { this.ownership =
     * ownership; }
     * 
     * private String[] coldstore;
     * 
     * public void setColdstore( String[] coldstore ) { this.coldstore =
     * coldstore; }
     * 
     * 
    ...
    private Integer organisationUnitGroupSets;

    public void setOrganisationUnitGroupSets( Integer organisationUnitGroupSets )
    {
        this.organisationUnitGroupSets = organisationUnitGroupSets;
    }
    
    private String cceiReportFileName;
        ...
        throws Exception, JRException
    {
        ...
        /*
         * if ( facilityTypeRadio.equalsIgnoreCase( "facilityType" ) ) { if (
         * option[0].isEmpty() ) { } else { for ( int i = 0; i <= option.length
         * - 1; i++ ) { orgunitGroupList.add( Integer.parseInt( option[i].trim()
         * ) ); } }
         * 
         * }
         * 
         * if ( facilityTypeRadio.equalsIgnoreCase( "ownershipType" ) ) { if (
         * ownership[0].isEmpty() ) { } else { for ( int i = 0; i <=
         * ownership.length - 1; i++ ) { orgunitGroupList.add( Integer.parseInt(
         * ownership[i].trim() ) ); } }
         * 
         * }
         * 
         * if ( facilityTypeRadio.equalsIgnoreCase( "coldStoreType" ) ) { if (
         * coldstore[0].isEmpty() ) { } else { for ( int i = 0; i <=
         * coldstore.length - 1; i++ ) { orgunitGroupList.add( Integer.parseInt(
         * coldstore[i].trim() ) ); } }
         * 
         * }
         */
        ...
        // System.out.println( " Size of  orgunitGroup List  " +
        // orgunitGroupList.size() );
        ...
        else
        {
            ...
            {
                OrganisationUnit organisationUnit = organisationUnitService.getOrganisationUnit( orgUnit[i].trim() );
                selOrgUnitList.add( organisationUnit.getId() );
        ...
        String path = System.getenv( "DHIS2_HOME" ) + File.separator + "ccei" + File.separator + "ireports"
            + File.separator;
        ...
        List<CCEMReportDesign> reportDesignList = new ArrayList<CCEMReportDesign>(
            ccemReportManager.getCCEMReportDesign( ccemReport.getXmlTemplateName() ) );
        ...
        else if ( periodRadio.equalsIgnoreCase( CCEMReport.LAST_1_MONTHS ) )
        {
            calendar.add( Calendar.MONTH, -1 );
            calendar.set( Calendar.DATE, 1 );
            sDate = calendar.getTime();
        ...
        else if ( periodRadio.equalsIgnoreCase( CCEMReport.CURRENT_MONTH ) )
        {
        ...
        //System.out.println( " Period Type  " + periodType.getName() + " Start Date " + dateFormat.format( sDate )  + " End  Date " + dateFormat.format( eDate ) );
        ...
        if ( ccemReport.getReportType().equals( CCEMReport.TOTAL_POPULATION ) )
        {
            ...
            cceiReportFileName = "Total population by facility type";
            ...
            try
            {
                for ( Integer orgUnitId : selOrgUnitList )
                {
                    ...
                    List<OrganisationUnit> orgUnitChildren = new ArrayList<OrganisationUnit>(
                    ...
                    for ( Integer orgUnitGroupId : orgunitGroupList )
                    {
                        ...
                        if ( orgUnitGroupMembers != null && orgUnitGroupMembers.size() > 0 )
                        {
                            ...
                            String minMaxandAvgValue = ccemReportManager.getMinMaxAvgValues( orgUnitidsByComma,
                                periodIdsByComma, dataElementId, optionComboId );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.LIVE_BIRTHS ) )
        {
            ...
            cceiReportFileName = "Live births by facility type";
                ...
                for ( Integer orgUnitId : selOrgUnitList )
                {
                    ...
                    for ( Integer orgUnitGroupId : orgunitGroupList )
                    {
                        ...
                        if ( orgUnitGroupMembers != null && orgUnitGroupMembers.size() > 0 )
                        {
                            ...
                            // String minMaxandAvgValue =
                            // ccemReportManager.getMinMaxAvgValues(
                            // orgUnitidsByComma, periodIdsByComma,
                            // dataElementId, optionComboId );
                            String minMaxandAvgValue = ccemReportManager
                                .getMinMaxAvgValuesForLiveBirths( orgUnitidsByComma, periodIdsByComma, dataElementId,
                                    optionComboId, liveBirthPerThousand );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.MODE_OF_VACCINE ) )
        {
            ...
            cceiReportFileName = "Mode of vaccine supply by facility type";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ELECTRICITY_AVAILABILITY_BY_FACILITY_TYPE ) )
        {
            ...
            cceiReportFileName = "Electricity availibility by facility type";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.KEROSENE_AVAILABILITY_BY_FACILITY_TYPE ) )
        {
            ...
            cceiReportFileName = "Kerosene Availability by facility type";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.GAS_AVAILABILITY_BY_FACILITY_TYPE ) )
        {
            ...
            cceiReportFileName = "Gas Availability by facility type";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ENERGY_AVAILABILITY_AT_FACILITIES ) )
        {
            ...
            cceiReportFileName = "Energy Availability at Facilities";
            ...
            {
                List<OrganisationUnit> orgUnitChildren = new ArrayList<OrganisationUnit>(
                    organisationUnitService.getOrganisationUnitWithChildren( orgUnit ) );
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    OrganisationUnitGroup orgUnitGroup = organisationUnitGroupService
                        .getOrganisationUnitGroup( orgUnitGroupId );
            ...
            hash.put(
                "chart",
                createSimpleBarChart( dataset, "Energy Availability at Facilities", "", "Number of Facilities",
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ELECTRICITY_AVAILABILITY ) )
        {
            ...
            cceiReportFileName = "Electricity Availability";
            ...
            if ( dataElemnet != null && dataElemnet.getOptionSet() != null )
            {
                List<String> options = new ArrayList<String>( dataElemnet.getOptionSet().getOptions() );
                for ( String option : options )
                {
                    frb.addColumn( option, dataElemnet.getId() + "_" + option, String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElemnet.getId() + "_" + option + "_%", String.class.getName(), 24, true );
                }
                ...
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    if ( totalFacilities != 0 )
                    {
                        ...
                        Map<String, Integer> dataValueCountMap = new HashMap<String, Integer>(
                            ccemReportManager.getDataValueAndCount( dataelementId + "", orgUnitidsByComma,
                                periodIdsByComma ) );
                        ...
                        if ( dataElemnet != null && dataElemnet.getOptionSet() != null )
                        {
                            ...
                            for ( String option : options )
                            {
                                ...
                                numberOfData.put( dataElemnet.getId() + "_" + option + "_%",
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.CATALOGTYPE_ATTRIBUTE_VALUE ) )
        {
            ...
            cceiReportFileName = "Refrigerators/freezer by Type";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.CATALOGTYPE_ATTRIBUTE_VALUE_BY_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "Refrigerators/freezers by working status, facility type and area";
            ...
            for ( Integer orgUnit : selOrgUnitList )
            {
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    Map<String, Integer> totalEquipmentMap = ccemReportManager.getModelNameAndCount(
                        modelTypeAttributeId, equipmentTypeId, null, orgUnitidsByComma );
                    Map<String, Integer> workingEquipmentMap = ccemReportManager.getModelNameAndCount(
                        modelTypeAttributeId, equipmentTypeId, EquipmentStatus.STATUS_WORKING_WELL, orgUnitidsByComma );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.WORKING_STATUS_BY_REFRIGERATORS_FREEZER_MODEL ) )
        {
            ...
            cceiReportFileName = "WORKING_STATUS_BY_REFRIGERATORS_FREEZER_MODEL";
            ...
            hash.put(
                "chart",
                createBarChart( dataset, "WORKING_STATUS_BY_REFRIGERATORS_FREEZER_MODEL", "", "Number of Equipment",
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATORS_FREEZER_BY_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "REFRIGERATORS_FREEZER_BY_WORKING_STATUS";
            ...
            Map<String, Integer> totalEquipmentMap = (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
                inventoryTypeId, null, orgUnitIdsByComma ));
            Map<String, Integer> workingEquipmentMap = (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
                inventoryTypeId, EquipmentStatus.STATUS_WORKING_WELL, orgUnitIdsByComma ));
            Map<String, Integer> repairEquipmentMap = (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
                inventoryTypeId, EquipmentStatus.STATUS_WORKING_NEEDS_MAINTENANCE, orgUnitIdsByComma ));
            ...
            for ( String model : modelsList )
            {
                ...
                {
                    total = Double.valueOf( totalEquipmentMap.get( model ) );
                    total = Math.round( total * Math.pow( 10, 0 ) ) / Math.pow( 10, 0 );
                }

                if ( workingEquipmentMap.containsKey( model ) )
                {
                    working = Double.valueOf( workingEquipmentMap.get( model ) );
                    working = Math.round( working * Math.pow( 10, 0 ) ) / Math.pow( 10, 0 );
                }

                if ( repairEquipmentMap.containsKey( model ) )
                {
                    repair = Double.valueOf( repairEquipmentMap.get( model ) );
                    repair = Math.round( repair * Math.pow( 10, 0 ) ) / Math.pow( 10, 0 );
                }
                if ( notWorkingEquipmentMap.containsKey( model ) )
                {
                    notWorking = Double.valueOf( notWorkingEquipmentMap.get( model ) );
                    notWorking = Math.round( notWorking * Math.pow( 10, 0 ) ) / Math.pow( 10, 0 );
                }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATORS_BY_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "REFRIGERATORS_BY_WORKING_STATUS";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_PIE ) )
        {
            ...
            cceiReportFileName = "Refrigerators/freezer models by age group";
            ...
            Map<String, Integer> catalogTypeAttributeValueMap1 = new HashMap<String, Integer>(
                ccemReportManager.getCatalogTypeAttributeValueByAge( orgUnitIdsByComma, equipmentTypeId,
                    modelTypeAttributeId, equipmentTypeAttributeId, 0, 2 ) );

            Map<String, Integer> catalogTypeAttributeValueMap2 = new HashMap<String, Integer>(
                ccemReportManager.getCatalogTypeAttributeValueByAge( orgUnitIdsByComma, equipmentTypeId,
                    modelTypeAttributeId, equipmentTypeAttributeId, 3, 5 ) );

            Map<String, Integer> catalogTypeAttributeValueMap3 = new HashMap<String, Integer>(
                ccemReportManager.getCatalogTypeAttributeValueByAge( orgUnitIdsByComma, equipmentTypeId,
                    modelTypeAttributeId, equipmentTypeAttributeId, 6, 10 ) );

            Map<String, Integer> catalogTypeAttributeValueMap4 = new HashMap<String, Integer>(
                ccemReportManager.getCatalogTypeAttributeValueByAge( orgUnitIdsByComma, equipmentTypeId,
                    modelTypeAttributeId, 3, 11, -1 ) );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_BAR ) )
        {
            ...
            hash.put(
                "chart2",
                createBarChart( dataset, "Refrigerators/Freezer Models by Age Group", "", "Number of Equipment",
                    PlotOrientation.VERTICAL ) );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION_PIE ) )
        {
            ...
            EquipmentTypeAttribute equipmentTypeAttribute = equipmentTypeAttributeService
                .getEquipmentTypeAttribute( equipmentUtilizationId );

            DefaultPieDataset dataset = new DefaultPieDataset();

            Map<String, Integer> equipmentValue_CountMap = new HashMap<String, Integer>(
                ccemReportManager.getEquipmentValue_Count( equipmentTypeId, equipmentUtilizationId, orgUnitIdsByComma ) );

            if ( equipmentTypeAttribute.getOptionSet() != null )
            {
                List<String> equipmentTypeAttributeOptions = new ArrayList<String>( equipmentTypeAttribute
                    .getOptionSet().getOptions() );
                for ( String equipmentTypeAttributeOption : equipmentTypeAttributeOptions )
                {
                    Integer equipmentValue_Count = equipmentValue_CountMap.get( equipmentTypeAttributeOption );
                    if ( equipmentValue_Count == null )
                    {
                        equipmentValue_Count = 0;
                    }

                    dataset.setValue( equipmentTypeAttributeOption, equipmentValue_Count );
                }
            }
            ...
            cceiReportFileName = "REFRIGERATOR FREEZER UTILIZATION";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION_BAR ) )
        {
            ...
            Map<String, Map<String, Integer>> modelName_EquipmentUnilization_CountMap = new HashMap<String, Map<String, Integer>>(
                ccemReportManager.getModelName_EquipmentUtilization_Count( equipmentTypeId, modelTypeAttributeId,
                    equipmentUtilizationId, orgUnitIdsByComma ) );
            Map<String, Integer> modelName_CountMap = new HashMap<String, Integer>(
                ccemReportManager.getModelName_Count( equipmentTypeId, modelTypeAttributeId, orgUnitIdsByComma ) );
            List<String> modelList = new ArrayList<String>( modelName_CountMap.keySet() );
            Collections.sort( modelList );

            for ( String model : modelList )
            {
                Map<String, Integer> equipmentUtilisationMap = new HashMap<String, Integer>(
                    modelName_EquipmentUnilization_CountMap.get( model ) );
                if ( equipmentTypeAttribute.getOptionSet() != null )
                {
                    List<String> inventoryTypeAttributeOptions = new ArrayList<String>( equipmentTypeAttribute
                        .getOptionSet().getOptions() );
                    for ( String inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                    {
                        Integer equipmentUtilisationCount = equipmentUtilisationMap.get( inventoryTypeAttributeOption );
                        ...
                        dataset.setValue( equipmentUtilisationCount, inventoryTypeAttributeOption, model );
                    }
                }
            }
            ...
            hash.put(
                "chart",
                createBarChart( dataset, "REFRIGERATOR FREEZER UTILIZATION", "", "Number of Equipment",
                    PlotOrientation.VERTICAL ) );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION ) )
        {
            ...
            if ( equipmentTypeAttribute.getOptionSet() != null )
            {
                ...
                for ( String inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                {
                    frb.addColumn( "#", inventoryTypeAttributeOption + "_#", String.class.getName(), 50, true );
                    frb.addColumn( "%", inventoryTypeAttributeOption + "_%", String.class.getName(), 50, true );
                }
                ...
                for ( String inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                {
                    frb.setColspan( colCount, 2, inventoryTypeAttributeOption );
                    colCount += 2;
                }
            }
             ...
             * ); frb.addColumn( "%", "In Use_%", String.class.getName(), 50,
             * true ); frb.addColumn( "#", "In Store_#", String.class.getName(),
             * 50, true ); frb.addColumn( "%", "In Store_%",
             * String.class.getName(), 50, true ); frb.addColumn( "#",
             * "Not Used_#", String.class.getName(), 50, true ); frb.addColumn(
             * "%", "Not Used_%", String.class.getName(), 50, true );
             * frb.addColumn( "#", "Unknown_#", String.class.getName(), 50, true
             * ); frb.addColumn( "%", "Unknown_%", String.class.getName(), 50,
             * true ); frb.setColspan( 2, 2, "In Use" ); frb.setColspan( 4, 2,
             * "In Store" ); frb.setColspan( 6, 2, "Not Used" ); frb.setColspan(
             * 8, 2, "Unknown Status" );
             * 
             * frb.setColspan( 2, 2, "In Use" ); frb.setColspan( 4, 2,
             * "In Store" ); frb.setColspan( 6, 2, "Not Used" ); frb.setColspan(
             * 8, 2, "Unknown Status" );
             */

            /*
             * Map<String, Integer> inuseEquipmentMap =
             * (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
             * inventoryTypeId, EquipmentStatus.STATUS_IN_USE, orgUnitIdsByComma
             * )); Map<String, Integer> instoreEquipmentMap =
             * (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
             * inventoryTypeId, EquipmentStatus.STATUS_IN_STORE,
             * orgUnitIdsByComma )); Map<String, Integer> notusedEquipmentMap =
             * (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
             * inventoryTypeId, EquipmentStatus.STATUS_NOT_IN_USE,
             * orgUnitIdsByComma )); Map<String, Integer> unknownEquipmentMap =
             * (ccemReportManager.getModelNameAndCount( catalogTypeAttributeId,
             * inventoryTypeId, EquipmentStatus.STATUS_UNKNOWN,
             * orgUnitIdsByComma ));
             */

            Map<String, Map<String, Integer>> modelName_EquipmentUnilization_CountMap = new HashMap<String, Map<String, Integer>>(
                ccemReportManager.getModelName_EquipmentUtilization_Count( inventoryTypeId, catalogTypeAttributeId,
                    equipmentUtilizationId, orgUnitIdsByComma ) );
            Map<String, Integer> modelName_CountMap = new HashMap<String, Integer>(
                ccemReportManager.getModelName_Count( inventoryTypeId, catalogTypeAttributeId, orgUnitIdsByComma ) );
            List<String> modelList = new ArrayList<String>( modelName_CountMap.keySet() );
            Collections.sort( modelList );
            for ( String model : modelList )
            {
                ...
                if ( equipmentTypeAttribute.getOptionSet() != null )
                {
                    ...
                    for ( String inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                    {
                        ...
                        if ( totalCount != 0 )
                        {
                            percentageEquipmentUtilisation = (double) equipmentUtilisationCount / (double) totalCount
                                * 100.0;
                            percentageEquipmentUtilisation = Math.round( percentageEquipmentUtilisation
                                * Math.pow( 10, 1 ) )
                                / Math.pow( 10, 1 );
                        }
                        ...
                        numberOfData.put( inventoryTypeAttributeOption + "_#", equipmentUtilisationCount + "" );
                        numberOfData.put( inventoryTypeAttributeOption + "_%", percentageEquipmentUtilisation + "" );
                    }
                }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.DISTRIBUTION_REFRIGERATOR_FREEZER_MODELS ) )
        {
            ...
            cceiReportFileName = "Distribution of Refrigerators/freezers by model and facility type";
        ...
        {
            hash.put( "reportName", "Linelist of equipment with working status = not working and working needs service" );
            
            cceiReportFileName = "Linelist of equipment with working status = not working and working needs service";
            ...
            for ( Integer orgUnitGroupId : orgunitGroupList )
            {
                for ( String catalogId : catalogIds )
                {
                    ...
                    numberOfData.put( "Model", modelService.getModel( Integer.parseInt( catalogId ) ).getName() );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.LINELIST_EQUIPMENT_WORKING_AND_NOT_WORKING ) )
        {
            ...
            cceiReportFileName = "Linelist of equipment with working status = working and not working";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.VACCINE_STORAGE_CAPACITY ) )
        {
            ...
            cceiReportFileName = "Vaccine storage capacity at +2 to +8C against requirements (in Litres)";
            ...
            Map<Integer, Double> equipmentSumByInventoryTypeMap = new HashMap<Integer, Double>(
                ccemReportManager.getSumOfEquipmentDatabyInventoryType( orgUnitIdsByComma, vscrActualInventoryTypeId,
                    vscrActualInventoryTypeAttributeId, factor ) );

            String[] partsOfVSRActualCellContent = partsOfCellContent[1].split( ":" );
            Integer vsrActualEquipmentTypeidId = Integer.parseInt( partsOfVSRActualCellContent[0] );
            Integer vsrActualModelTypeAttributeidId = Integer.parseInt( partsOfVSRActualCellContent[1] );
            ...
            Map<Integer, Double> catalogSumByEquipmentDataMap = new HashMap<Integer, Double>(
                ccemReportManager.getCatalogDataSumByEquipmentData( orgUnitIdsByComma, vsrActualEquipmentTypeidId,
            ...
            List<Integer> catalogIdsForRequirement = new ArrayList<Integer>(
                ccemReportManager.getCatalogIdsForRequirement( vsReqCatalogTypeId, vsReqStorageTempId,
                    vsReqStorageTemp, vsReqNationalSupplyId, vsReqNationalSupply ) );
            ...
            Map<String, String> dataElementDataForRequirement = new HashMap<String, String>(
                ccemReportManager.getDataElementDataForCatalogOptionsForRequirement( orgUnitIdsByComma, dataelementIds,
                    periodId ) );
            ...
            // PART 4 - 151,144OR3,4
            String deIds = partsOfCellContent[3].split( "OR" )[0];
            Integer vsReqSupplyIntervalDe = Integer.parseInt( deIds.split( "," )[0] );
            Integer vsReqReserveStockDe = Integer.parseInt( deIds.split( "," )[1] );

            String orgUnitGroupAttribIds = partsOfCellContent[3].split( "OR" )[1];
            ...
            Map<String, String> dataValueMapForRequirement = new HashMap<String, String>(
                ccemReportManager.getDataValueMapForRequirement( orgUnitIdsByComma, deIds, periodId ) );

            Map<String, String> orgUnitGroupAttribDataForRequirement = new HashMap<String, String>(
                ccemReportManager.getOrgUnitGroupAttribDataForRequirement( orgUnitGroupIdsByComma,
                    orgUnitGroupAttribIds ) );

            Map<Integer, String> orgUnitGroupMap = new HashMap<Integer, String>(
                ccemReportManager.getOrgunitAndOrgUnitGroupMap( orgUnitGroupIdsByComma, orgUnitIdsByComma ) );
            ...
            for ( OrganisationUnit orgUnit : orgUnitList )
            {
                ...
                tempStr = dataValueMapForRequirement.get( orgUnit.getId() + ":" + vsReqSupplyIntervalDe );
                if ( tempStr == null )
                {
                    tempStr = orgUnitGroupAttribDataForRequirement.get( orgUnit.getId() + ":" + vsReqSupplyInterval );
                }

                // tempStr = orgUnitGroupAttribDataForRequirement.get(
                // orgUnit.getId() + ":" + vsReqSupplyInterval );
                if ( tempStr != null )
                {
                    try
                    {
                ...
                tempStr = dataValueMapForRequirement.get( orgUnit.getId() + ":" + vsReqReserveStockDe );
                if ( tempStr == null )
                {
                ...
                // tempStr = orgUnitGroupAttribDataForRequirement.get(
                // orgUnit.getId() + ":" + vsReqReserveStock );
                if ( tempStr != null )
                {
                    try
                    {
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.VACCINE_STORAGE_CAPACITY_BAR ) )
        {
            ...
            Map<Integer, Double> catalogSumByEquipmentDataMap = new HashMap<Integer, Double>(
                ccemReportManager.getCatalogDataSumByEquipmentData( orgUnitIdsByComma, vsrActualInventoryTypeId,
            ...
            for ( OrganisationUnit orgUnit : orgUnitList )
            {
                ...
                // for ( Integer catalogId : catalogIdsForRequirement )
                {
                    ...
                    if ( tempStr == null )
                    {
                        tempStr = orgUnitGroupAttribDataForRequirement
                            .get( orgUnit.getId() + ":" + vsReqSupplyInterval );
                    }
            ...
            hash.put(
                "chart",
                createBarChart2( dataset, "Vaccine Storage Capacity at +2 to +8C Against Requirements (in Litres)", "",
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.VACCINE_STORAGE_CAPACITY_FOR_LESS_THAN_20 ) )
        {
            ...
            Map<String, String> catalogDataForRequirement = new HashMap<String, String>(
                ccemReportManager.getCatalogDataForRequirement( vsReqCatalogTypeId, vsReqStorageTempId,
                    vsReqStorageTemp, vsReqNationalSupplyId, vsReqNationalSupply, vsReqCatalogAttribIds ) );
            ...
            {
                catalogOption_DataelementMap.put( de_catalogOption.split( ":" )[1],
                    Integer.parseInt( de_catalogOption.split( ":" )[0] ) );
                catalogOption_DataelementIds += "," + Integer.parseInt( de_catalogOption.split( ":" )[0] );
            }

            Map<String, String> dataElementDataForRequirement = new HashMap<String, String>(
                ccemReportManager.getDataElementDataForCatalogOptionsForRequirement( orgUnitIdsByComma,
                    catalogOption_DataelementIds, periodId ) );
            ...
            cceiReportFileName = "VACCINE_STORAGE_CAPACITY";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.VACCINE_STORAGE_CAPACITY_FOR_LESS_THAN_20_BAR ) )
        {
            ...
            hash.put(
                "chart",
                createBarChart2( dataset, "WORKING_STATUS_BY_REFRIGERATORS_FREEZER_MODEL", "",
                    "Number of Health Facility", PlotOrientation.HORIZONTAL ) );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.EQUIPMENT_BY_AVAILABILITY_OF_ELECTRICITY ) )
        {
            ...
            cceiReportFileName = "Equipment by availability of electricity";
            ...
            // ccemReportManager.getEquipmentNameWithOrgUnit( inventoryTypeId,
            // catalogTypeAttributeId, orgUnitIdsByComma );
            // TreeMap<String, String> sortedEquipmentMap = new TreeMap<String,
            // String>( equipmentMap );
            Map<String, Map<String, Integer>> equiplmentType_ElectricityAvailability_CountMap = new HashMap<String, Map<String, Integer>>(
                ccemReportManager.getEquipmentType_ElectricityAvailability_Count( equipmentTypeId,
                    modelTypeAttributeId, electricityId, periodIdsByComma, orgUnitIdsByComma ) );
            List<String> equiplmentTypeList = new ArrayList<String>(
                equiplmentType_ElectricityAvailability_CountMap.keySet() );
            Collections.sort( equiplmentTypeList );
            for ( String equipment : equiplmentTypeList )
            {
                Map<String, Integer> electricityAvailabilityMap = new HashMap<String, Integer>(
                    equiplmentType_ElectricityAvailability_CountMap.get( equipment ) );
                Map<String, String> numberOfData = new HashMap<String, String>();
                List<String> options = new ArrayList<String>( dataElemnet.getOptionSet().getOptions() );
            ...
            CCEMReport.SUMMARY_OF_ABSORPTION_REFRIGERATORS_EXISTING_IN_fACILITIES ) )
        {
            hash.put( "reportName",
                "Summary of absorption refrigerators existing in facilities with >8/24 electricity per day" );
            
            cceiReportFileName = "Summary of absorption refrigerators existing in facilities with >8/24 electricity per day";
            ...
            electricity8to16hrsOption = electricity8to16hrsOption.toLowerCase();
            electricityMorethan16hrsOption = electricityMorethan16hrsOption.toLowerCase();
            electricityGas = electricityGas.toLowerCase();
            electricityKerosene = electricityKerosene.toLowerCase();
            ...
            frb.addColumn( "Area", "Area", String.class.getName(), 100, true );
            frb.addColumn( "Facility Type", "Facility Type", String.class.getName(), 100, true );
            frb.addColumn( "Total Number of Refrigerators", "Total Number of Refrigerators", String.class.getName(),
                100, true );
            frb.addColumn( "#", "#", String.class.getName(), 50, true );
            frb.addColumn( "%", "%", String.class.getName(), 50, true );
            ...
            for ( Integer orgUnitId : selOrgUnitList )
            {
                ...
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    if ( orgUnitGroupMemberIds != null && orgUnitGroupMemberIds.size() > 0 )
                    {
                        List<String> facilityList = ccemReportManager.getDataValueFacility( dataelementId, "\'"
                            + electricity8to16hrsOption + "\',\'" + electricityMorethan16hrsOption + "\'",
                            orgUnitidsByComma, periodIdsByComma );
                        ...
                        {
                            // Integer totalValue =
                            // ccemReportManager.getCatalogDataValueCount(
                            // inventoryTypeId, catalogTypeAttributeId, null,
                            // facilityByComma );
                            Integer totalValue = ccemReportManager.getEquipmentInstanceCount( equipmentTypeId,
                                facilityByComma );

                            Integer absorptionValue = ccemReportManager.getCatalogDataValueCount( equipmentTypeId,
                                modelTypeAttributeId, "\'" + electricityGas + "\',\'" + electricityKerosene + "\'",
                                facilityByComma );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ALL_ENERGY_AVAILABILITY_AT_FACILITIES ) )
        {
            ...
            frb.addColumn( "Admin Area", "Admin Area", String.class.getName(), 32, true );
            frb.addColumn( "Facility Type", "Facility Type", String.class.getName(), 32, true );
            frb.addColumn( "Total Facilities", "Total Facilities", String.class.getName(), 32, true );
            ...
            if ( dataElement1.getOptionSet() != null )
            {
                ...
                {
                    frb.addColumn( option, dataElement1.getId() + "_" + option, String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement1.getId() + "_" + option + "_%", String.class.getName(), 24, true );
                }
            }
            ...
            if ( dataElement2.getOptionSet() != null )
            {
                ...
                {
                    frb.addColumn( option, dataElement2.getId() + "_" + option, String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement2.getId() + "_" + option + "_%", String.class.getName(), 24, true );
                }
            }
            ...
            if ( dataElement3.getOptionSet() != null )
            {
                ...
                {
                    frb.addColumn( option, dataElement3.getId() + "_" + option, String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement3.getId() + "_" + option + "_%", String.class.getName(), 24, true );
                }
            }
            ...
            for ( Integer orgUnitId : selOrgUnitList )
            {
                ...
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    if ( totalFacilities != 0 )
                    {
                        ...
                        Map<String, Integer> dataValueCountMap = new HashMap<String, Integer>(
                            ccemReportManager.getDataValueAndCount( dataelementId1 + "", orgUnitidsByComma,
                                periodIdsByComma ) );
                        ...
                        if ( dataElement1.getOptionSet() != null )
                        {
                            ...
                            for ( String option : options )
                            {
                                ...
                                numberOfData.put( dataElement1.getId() + "_" + option + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
                        ...
                        if ( dataElement2.getOptionSet() != null )
                        {
                            ...
                            for ( String option : options )
                            {
                                ...
                                numberOfData.put( dataElement2.getId() + "_" + option + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
                        ...
                        if ( dataElement3.getOptionSet() != null )
                        {
                            ...
                            for ( String option : options )
                            {
                                ...
                                numberOfData.put( dataElement3.getId() + "_" + option + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.COLD_ROOM_BY_MODEL_AND_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "Cold Rooms by model and working status";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.LISTING_OF_COLD_ROOM_FACILITIES_AND_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "Listing of cold room facilities and working status";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.COLD_ROOM_QUALITY_ATTRIBUTES ) )
        {
            ...
            cceiReportFileName = "Cold room quality attributes";
            ...
            CCEMReport.COLD_BOX_AND_VACCINE_CARRIERS_BY_MODEL_AND_WORKING_STATUS ) )
        {
            ...
            cceiReportFileName = "Cold box and vaccine carriers by model and working status";
            ...
            List<OrganisationUnitGroup> selOrgUnitGroupList = new ArrayList<OrganisationUnitGroup>();
            for ( int i = 0; i <= orgunitGroupList.size() - 1; i++ )
            {
                ...
                selOrgUnitGroupList.add( orgUnitGroup );
            }
            for ( int i = 0; i <= orgunitGroupList.size() - 1; i++ )
            {
                OrganisationUnitGroup orgUnitGroup = organisationUnitGroupService
            ...
            Map<String, Integer> orgUnitGroupwiseQtyPresentMap = new HashMap<String, Integer>();
            Map<String, Integer> orgUnitGroupwiseQtyNowWorkingMap = new HashMap<String, Integer>();
            for ( OrganisationUnitGroup orgUnitGroup : selOrgUnitGroupList )
            {
                List<Integer> orgUnitGrpIdList = new ArrayList<Integer>();
                orgUnitGrpIdList.add( orgUnitGroup.getId() );

                String orgUnitidsByComma = ccemReportManager.getOrgunitIdsByComma( selOrgUnitList, orgUnitGrpIdList );

                Map<String, Integer> qtyPresentMap = ccemReportManager.getSumOfColdBoxByOrgUnitGroup( equipmentTypeId,
                    qtyPresentEquipmentTypeAttributeId, modelTypeAttributeId, orgUnitidsByComma, orgUnitGroup.getId() );
                Map<String, Integer> qtyNotWorkingMap = ccemReportManager.getSumOfColdBoxByOrgUnitGroup(
                    equipmentTypeId, qtyNotWorkingEquipmentTypeAttributeId, modelTypeAttributeId, orgUnitidsByComma,
                    orgUnitGroup.getId() );

                if ( qtyPresentMap != null )
                {
                    orgUnitGroupwiseQtyPresentMap.putAll( qtyPresentMap );
                }

                if ( qtyNotWorkingMap != null )
                {
                    orgUnitGroupwiseQtyNowWorkingMap.putAll( qtyNotWorkingMap );
                }
            }
            ...
            for ( String model : modelsList )
            {
                ...
                for ( OrganisationUnitGroup orgUnitGroup : selOrgUnitGroupList )
                {
                    Integer qtyPresent = orgUnitGroupwiseQtyPresentMap.get( orgUnitGroup.getId() + ":" + model );
                    Integer qtyNotWorking = orgUnitGroupwiseQtyNowWorkingMap.get( orgUnitGroup.getId() + ":" + model );

                    if ( qtyPresent == null )
                        qtyPresent = 0;
                    if ( qtyNotWorking == null )
                        qtyNotWorking = 0;

                    Integer qtyWorking = qtyPresent - qtyNotWorking;

                    numberOfData.put( "W" + orgUnitGroup.getName(), qtyWorking + "" );
                    numberOfData.put( "NW" + orgUnitGroup.getName(), qtyNotWorking + "" );
                    System.out.println( model + " - " + orgUnitGroup.getName() + " - " + qtyPresent + " - "
                        + qtyWorking + " - " + qtyNotWorking );
                }
            ...
            CCEMReport.COLD_BOX_AND_VACCINE_CARRIERS_BY_MODEL_AND_WORKING_STATUS_BAR ) )
        {
            ...
            Map<String, Double> qtyPresentMap = ccemReportManager.getSumOfEquipmentAndCatalogValue( equipmentTypeId,
                qtyPresentEquipmentTypeAttributeId, modelTypeAttributeId, orgUnitIdsByComma );
            Map<String, Double> qtyNotWorkingMap = ccemReportManager.getSumOfEquipmentAndCatalogValue( equipmentTypeId,
                qtyNotWorkingEquipmentTypeAttributeId, modelTypeAttributeId, orgUnitIdsByComma );

            // Map<String, Integer> workingEquipmentMap =
            // (ccemReportManager.getModelNameAndCountForColdBox(
            // catalogTypeAttributeId, inventoryTypeId, 1 + "",
            // orgUnitIdsByComma ));
            // Map<String, Integer> notWorkingEquipmentMap =
            // (ccemReportManager.getModelNameAndCountForColdBox(
            // catalogTypeAttributeId, inventoryTypeId, 0 + "",
            // orgUnitIdsByComma ));
            ...
            for ( String model : modelsList )
            {
                ...
                {
                    dataset.setValue( qtyPresentMap.get( model ), "Working", model );
                }
                else
                {
                    dataset.setValue( 0, "Working", model );
                ...
                if ( qtyNotWorkingMap.containsKey( model ) )
                {
                    dataset.setValue( qtyNotWorkingMap.get( model ), "Not Working", model );
                }
                else
                {
                    dataset.setValue( 0, "Not Working", model );
            ...
            hash.put(
                "chart",
                createBarChart2( dataset, "Cold box and vaccine carriers by model and working status", "", "",
                    PlotOrientation.HORIZONTAL ) );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.QUANTITY_OF_COLD_BOXES_OR_CARRIERS ) )
        {
            ...
            cceiReportFileName = "Quantity of Cold Boxes/carriers";
            ...
            Map<String, Double> quantityMap = ccemReportManager.getSumOfEquipmentAndCatalogValue( equipmentTypeId,
            ...
            hash.put( "chart",
                createSimpleBarChart( dataset, "Quantity of Cold Boxes/carriers", "", "", PlotOrientation.HORIZONTAL ) );
            fileName = "Bar_Refrigerator_freezer_utilization.jrxml";
            JasperReport jasperReport = JasperCompileManager.compileReport( path + fileName );
            jasperPrint = JasperFillManager.fillReport( jasperReport, hash, new JREmptyDataSource() );
        }
        else if ( ccemReport.getReportType().equals( CCEMReport.ORGUNITGROUP_DATAVALUE ) )
        {
            ...
            for ( CCEMReportDesign ccemReportDesign1 : reportDesignList )
            {
                ...
                List<String> distinctDataElementValues = new ArrayList<String>(
                    ccemReportManager.getDistinctDataElementValue( dataElementId, optComboId, periodId ) );
                int number = 0;
            ...
            for ( Integer orgUnitGroupId : orgunitGroupList )
            {
                ...
                else
                {
                    ...
                    Map<String, Integer> dataValueCountMap2 = new HashMap<String, Integer>(
                        ccemReportManager.getDataValueCountforDataElements( dataElementIdsByComma, optComboIdsByComma,
                            periodId, orgUnitIdsBycomma ) );
            ...
            cceiReportFileName = "ORGUNITGROUP_DATAVALUE";
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ORGUNIT_EQUIPMENT_ROUTINE_DATAVALUE ) )
        {
            ...
            Map<String, Integer> equipmentDataValueMap = new HashMap<String, Integer>(
                ccemReportManager.getFacilityWiseEquipmentRoutineData( orgUnitIdsByComma, periodIdsByComma,
                    dataElementIdsByComma, optComboIdsByComma ) );
            ...
            cceiReportFileName = "ORGUNIT_EQUIPMENT_ROUTINE_DATAVALUE";
        }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.SERVICE_AND_REPAIR ) )
        {
            hash.put( "reportName", "Service and Repair Report" );
            
            cceiReportFileName = "Service and Repair Report ";

            CCEMReportDesign ccemReportDesign = reportDesignList.get( 0 );
            String ccemCellContent = ccemSettingsMap.get( ccemReportDesign.getContent() );
            Integer equipmentTypeId = Integer.parseInt( ccemCellContent.split( ":" )[0] );
            Integer equipmentTypeModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[1] );
            Integer manufacturereModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[2] );
            Integer modelModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[3] );
            
            
            String modelTypeAttributeIdsByComma = "-1";
            modelTypeAttributeIdsByComma += "," + equipmentTypeModelTypeAttributeId;
            modelTypeAttributeIdsByComma += "," + manufacturereModelTypeAttributeId;
            modelTypeAttributeIdsByComma += "," + modelModelTypeAttributeId;
            
            
            Map<String, String> modelAttributeValueMap = new HashMap<String, String>( ccemReportManager.getModelAttributeValueForModelTypeAttributeId( modelTypeAttributeIdsByComma ) );
            
            Map<String, String> typeCountAndMaxDateMap = new HashMap<String, String>( ccemReportManager.getTypeCountAndMaxDateFromEquipmentStatus( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            
            Map<Integer, String> partsReplacedCountMap = new HashMap<Integer, String>( ccemReportManager.getPartsReplacedCount( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            ...
            FastReportBuilder frb = new FastReportBuilder();
            frb.addColumn( "Facility", "Facility", String.class.getName(), 70, true );
            frb.addColumn( "Designation", "Designation", String.class.getName(), 60, true );
            //frb.addColumn( "Type", "Type", String.class.getName(), 50, true );
            frb.addColumn( "Make/Manufacturar", "Make/Manufacturar", String.class.getName(), 60, true );
            
            frb.addColumn( "Model", "Model", String.class.getName(), 60, true );
            frb.addColumn( "Asset Tag", "Asset Tag", String.class.getName(), 50, true );
            frb.addColumn( "Service", "Service", String.class.getName(), 50, true );
            frb.addColumn( "Repair", "Repair", String.class.getName(), 50, true );
            frb.addColumn( "Last Service Date", "Last Service Date", String.class.getName(), 60, true );
            frb.addColumn( "Last Repair Date", "Last Repair Date", String.class.getName(), 60, true );
            frb.addColumn( "Parts Uses", "Parts Uses", String.class.getName(), 50, true );
            
            //List<OrganisationUnit> orgUnits = new ArrayList<OrganisationUnit>( ccemReportManager.getOrgunits( selOrgUnitList, orgunitGroupList ) );
            
            //List<OrganisationUnit> equipmentOrgUnits = new ArrayList<OrganisationUnit>( ccemReportManager.getEquipmentStatusOrgunits( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            
            //orgUnits.retainAll( equipmentOrgUnits );
            
            List<Equipment> equipmentList =  new ArrayList<Equipment>( ccemReportManager.getServiceAndRepairEquipmentList( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            
            
            
            for ( Equipment equipment : equipmentList )
            {
                //String make = equipment.getModel().getName().split( "+" )[0];
                //String model = equipment.getModel().getName().split( "+" )[1];
                    
                Map<String, String> numberOfData = new HashMap<String, String>();
                numberOfData.put( "Facility", equipment.getOrganisationUnit().getName() );
                numberOfData.put( "Designation", modelAttributeValueMap.get( equipment.getModel().getId() + ":" + equipmentTypeModelTypeAttributeId ) );
                //numberOfData.put( "Type", equipment.getName() );
                numberOfData.put( "Make/Manufacturar",  modelAttributeValueMap.get( equipment.getModel().getId() + ":" + manufacturereModelTypeAttributeId )  );
                numberOfData.put( "Model",  modelAttributeValueMap.get( equipment.getModel().getId() + ":" + modelModelTypeAttributeId )  );
                numberOfData.put( "Asset Tag", equipment.getEquipmentTrackingID() );
                
                //System.out.println( "equipment id : " + equipment.getId()  + " Service value is : "  + typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ) );
                
                //System.out.println( "equipment id : " + equipment.getId()  + " Repair value is : "  + typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ) );
                
                String noOfService = "";
                String maxServiceDate = "";
                
                if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ) != null )
                {
                    if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ).split( ":" )[0] != null )
                    {
                        noOfService = typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ).split( ":" )[0];
                    }
                    
                    if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ).split( ":" )[1] != null )
                    {
                        maxServiceDate = typeCountAndMaxDateMap.get( equipment.getId() + ":" + "service" ).split( ":" )[1];
                    }
                }
                
                String noOfRepair = "";
                String maxRepairDate =  "";
                
                //System.out.println( "equipment id" + equipment.getId()  + " value is : "  + typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ) );
                
                
                if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ) != null )
                {
                    if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[0] != null )
                    {
                        noOfRepair = typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[0];
                    }
                    
                    if( typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[1] != null )
                    {
                        maxRepairDate = typeCountAndMaxDateMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[1];
                    }
                }
                
                numberOfData.put( "Service", noOfService );
                numberOfData.put( "Repair", noOfRepair );
                numberOfData.put( "Last Service Date", maxServiceDate );
                numberOfData.put( "Last Repair Date", maxRepairDate );
                
                String partsReplacedCount = "";
                
                if( partsReplacedCountMap.get( equipment.getId() ) != null )
                {
                    partsReplacedCount = partsReplacedCountMap.get( equipment.getId() );
                }
                
                numberOfData.put( "Parts Uses",  partsReplacedCount );
            ...
            frb.setColumnsPerPage( 1, 15 ).setUseFullPageWidth( true );
            frb.setPrintBackgroundOnOddRows( true );
            frb.setTemplateFile( path + "Service_and_Repair_Report.jrxml" );
        ...
        //  Awaiting Repair Report
        
        
        else if ( ccemReport.getReportType().equals( CCEMReport.AWAITING_REPAIR ) )
        {
            hash.put( "reportName", "Awaiting Repair Report" );
            
            cceiReportFileName = "Awaiting Repair Report";
            ...
            Integer manufacturereModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[2] );
            Integer modelModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[3] );
            String awaitingRepair =  ccemCellContent.split( ":" )[4] ;
            ...
            Map<String, String> typeCountAndMaxDateAwaitingRepairStatusMap = new HashMap<String, String>( ccemReportManager.getTypeCountAndMaxDateFromEquipmentAwaitingRepairStatus( dateFormat.format( sDate ), dateFormat.format( eDate ), awaitingRepair ) );
            ...
            FastReportBuilder frb = new FastReportBuilder();
            frb.addColumn( "Facility", "Facility", String.class.getName(), 60, true );
            frb.addColumn( "Designation", "Designation", String.class.getName(), 50, true );
            //frb.addColumn( "Type", "Type", String.class.getName(), 50, true );
            frb.addColumn( "Make/Manufacturar", "Make/Manufacturar", String.class.getName(), 50, true );
            
            frb.addColumn( "Model", "Model", String.class.getName(), 50, true );
            frb.addColumn( "Asset Tag", "Asset Tag", String.class.getName(), 50, true );
            frb.addColumn( "Reasons Not Working", "Reasons Not Working", String.class.getName(), 50, true );
            ...
            List<Equipment> equipmentList =  new ArrayList<Equipment>( ccemReportManager.getAwaitingRepairEquipmentList( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            ...
            for ( Equipment equipment : equipmentList )
            {
                ...
                numberOfData.put( "Reasons Not Working", equipment.getEquipmentStatus().getReasonNotWorking() );
                
                //System.out.println( "equipment id : " + equipment.getId()  + " Service value is : "  + typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ) );
                
                //System.out.println( "equipment id : " + equipment.getId()  + " Repair value is : "  + typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ) );
                
                String noOfService = "";
                String maxServiceDate = "";
                
                if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ) != null )
                {
                    if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ).split( ":" )[0] != null )
                    {
                        noOfService = typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ).split( ":" )[0];
                    }
                    
                    if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ).split( ":" )[1] != null )
                    {
                        maxServiceDate = typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "service" ).split( ":" )[1];
                    }
                }
                ...
                if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ) != null )
                {
                    if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[0] != null )
                    {
                        noOfRepair = typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[0];
                    }
                    
                    if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[1] != null )
                    {
                        maxRepairDate = typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[1];
                    }
                }
            ...
            frb.setColumnsPerPage( 1, 15 ).setUseFullPageWidth( true );
            frb.setPrintBackgroundOnOddRows( true );
            frb.setTemplateFile( path + "Awaiting_Repair.jrxml" );
       ...
       //  PARTS USAGE REPORT
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.PARTS_USAGE ) )
        {
            hash.put( "reportName", "Parts Usage Report" );
            
            cceiReportFileName = "Parts Usage Report";
            ...
            Map<Integer, String> partsReplacedMap = new HashMap<Integer, String>( ccemReportManager.getPartsUses( dateFormat.format( sDate ), dateFormat.format( eDate ) ) );
            ...
            FastReportBuilder frb = new FastReportBuilder();
            frb.addColumn( "Facility", "Facility", String.class.getName(), 50, true );
            frb.addColumn( "Designation", "Designation", String.class.getName(), 50, true );
            //frb.addColumn( "Type", "Type", String.class.getName(), 50, true );
            frb.addColumn( "Make/Manufacturar", "Make/Manufacturar", String.class.getName(), 50, true );
            
            frb.addColumn( "Model", "Model", String.class.getName(), 60, true );
            frb.addColumn( "Asset Tag", "Asset Tag", String.class.getName(), 40, true );
            frb.addColumn( "Service", "Service", String.class.getName(), 40, true );
            frb.addColumn( "Repair", "Repair", String.class.getName(), 40, true );
            frb.addColumn( "Last Service Date", "Last Service Date", String.class.getName(), 55, true );
            frb.addColumn( "Last Repair Date", "Last Repair Date", String.class.getName(), 55, true );
            frb.addColumn( "Parts Uses", "Parts Uses", String.class.getName(), 40, true );
            frb.addColumn( "Parts", "Parts", String.class.getName(), 80, true );
            ...
            for ( Equipment equipment : equipmentList )
            {
                ...
                if( partsReplacedMap.get( equipment.getId() ) != null )
                {
                    partsReplaced = partsReplacedMap.get( equipment.getId() );
                }
                
                
                numberOfData.put( "Parts",  partsReplaced );
            ...
            frb.setColumnsPerPage( 1, 15 ).setUseFullPageWidth( true );
            frb.setPrintBackgroundOnOddRows( true );
            frb.setTemplateFile( path + "Parts_usage.jrxml" );
        ...
        //  Days Waiting Repair Report
        
        
        else if ( ccemReport.getReportType().equals( CCEMReport.DAYS_WAITING_REPAIR_REPORT ) )
        {
            hash.put( "reportName", "Days Waiting Repair Report" );
            
            cceiReportFileName = "Days Waiting Repair Report";
            ...
            frb.addColumn( "Date Repair Requested", "Date Repair Requested", String.class.getName(), 60, true );
            frb.addColumn( "Days Waiting Repair", "Days Waiting Repair", String.class.getName(), 70, true );
            ...
            for ( Equipment equipment : equipmentList )
            {
                ...
                if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ) != null )
                {
                    ...
                    if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[1] != null )
                    {
                        ...
                        /*
                        if( typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[2] != null )
                        {
                            String maxUpdatingDate = typeCountAndMaxDateAwaitingRepairStatusMap.get( equipment.getId() + ":" + "repair" ).split( ":" )[2];
                            
                            firstDate = format.parseDate( maxRepairDate );
                            secondDate = format.parseDate( maxUpdatingDate );
                        }
                        ...
                        */
                        ...
                        Date firstDate = format.parseDate( maxRepairDate );
                        Date secondDate = new Date();
                        
                        int dayDiff = daysBetween( firstDate, secondDate );
                        
                        /*
                        Calendar tempSDate = Calendar.getInstance();
                        Calendar tempEDate = Calendar.getInstance();

                        tempSDate.setTime( firstDate );
                        tempEDate.setTime( secondDate );
                        
                        long milis1 = tempSDate.getTimeInMillis();
                        long milis2 = tempEDate.getTimeInMillis();

                        long dayDiffInMilliSeconds = milis2 - milis1;
                        
                        long daysDiffrence = dayDiffInMilliSeconds / ( 24 * 60 * 60 * 1000 );
                        
                        noOfDaysWaiting = "" + daysDiffrence;
                        
                        System.out.println( "equipment id " + equipment.getId()  + " Day Diffrence is : "  + daysDiffrence );
                        */
                        
                        noOfDaysWaiting = "" + dayDiff ;
                        
                    }
                }
                

                numberOfData.put( "Date Repair Requested", maxRepairDate );
                numberOfData.put( "Days Waiting Repair", noOfDaysWaiting );
            ...
            frb.setColumnsPerPage( 1, 15 ).setUseFullPageWidth( true );
            frb.setPrintBackgroundOnOddRows( true );
            frb.setTemplateFile( path + "Days_waiting_Repair.jrxml" );
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.EQUIPMENT_AGE_REPORT ) )
        {
            hash.put( "reportName", "Equipment Age Report" );
            
            cceiReportFileName = "Equipment Age Report";
            ...
            Integer manufacturereModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[2] );
            Integer modelModelTypeAttributeId = Integer.parseInt( ccemCellContent.split( ":" )[3] );
            String equipmentTypeAttributeId =  ccemCellContent.split( ":" )[4];
            ...
            Map<String, String> equipmentTypeAttributeValueMap = new HashMap<String, String>( ccemReportManager.getEquipmentTypeAttributeValue( equipmentTypeAttributeId ) );
            ...
            frb.addColumn( "Model", "Model", String.class.getName(), 60, true );
            frb.addColumn( "Asset Tag", "Asset Tag", String.class.getName(), 50, true );
            frb.addColumn( "Manufacturar Year", "Manufacturar Year", String.class.getName(), 60, true );
            
            frb.addColumn( "Registration Year", "Registration Date", String.class.getName(), 50, true );
            frb.addColumn( "Age(Years)", "Age(Years)", String.class.getName(), 50, true );
            
            
            List<OrganisationUnit> orgUnits = new ArrayList<OrganisationUnit>( ccemReportManager.getOrgunits( selOrgUnitList, orgunitGroupList ) );
            
            Collections.sort( orgUnits );
            //List<Equipment> equipmentList =  new ArrayList<Equipment>( equipmentService.getEquipments( orgUnit, equipmentType ) );
            ...
            for ( OrganisationUnit orgUnit : orgUnits )
            {
                ...
                for ( Equipment equipment : equipmentList )
                {
                    ...
                    numberOfData.put( "Manufacturar Year",  equipmentTypeAttributeValueMap.get( equipment.getId() + ":" + equipmentTypeAttributeId )  );
                    
                    numberOfData.put( "Registration Year", yearFormat.format( equipment.getRegistrationDate() ) );
                    ...
                    if( equipmentTypeAttributeValueMap.get( equipment.getId() + ":" + equipmentTypeAttributeId ) != null && equipment.getRegistrationDate() != null )
                    {
                        //int age = Integer.parseInt( currentYear ) -  Integer.parseInt( yearFormat.format( equipment.getRegistrationDate() ) );
                        int age = Integer.parseInt( currentYear ) -  Integer.parseInt( equipmentTypeAttributeValueMap.get( equipment.getId() + ":" + equipmentTypeAttributeId ) );
                        
                        equipmentAge = ""+age;
                    }
                    
                    numberOfData.put( "Age(Years)", equipmentAge );
            ...
            frb.setColumnsPerPage( 1, 15 ).setUseFullPageWidth( true );
            frb.setPrintBackgroundOnOddRows( true );
            frb.setTemplateFile( path + "Equipment_Age_Report.jrxml" );
        ...
        if ( "pdf".equalsIgnoreCase( type ) )
        {
            ...
            response.setHeader( "Content-Disposition", "inline; fileName=\"" + cceiReportFileName + ".pdf\"" );
        ...
        else if ( "rtf".equalsIgnoreCase( type ) )
        {
            ...
            response.setHeader( "Content-Disposition", "inline; fileName=\"" + cceiReportFileName + ".rtf\"" );
        ...
        else if ( "xls".equalsIgnoreCase( type ) )
        {
            ...
            response.setHeader( "Content-Disposition", "inline; fileName=\"" + cceiReportFileName + ".xls\"" );
        ...
        else if ( "csv".equalsIgnoreCase( type ) )
        {
            ...
            response.setHeader( "Content-Disposition", "inline; fileName=\"" + cceiReportFileName + ".csv\"" );
    ...
    // No of  days Difference calculation
