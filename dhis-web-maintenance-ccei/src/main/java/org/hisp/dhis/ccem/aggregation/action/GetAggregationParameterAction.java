    ...
    implements Action
{
    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        else if( aggTypeId.equals( Lookup.CCEI_AGG_TYPE_REF_WORKING_STATUS ) )
        {
        ...
        else if( aggTypeId.equals( Lookup.CCEI_AGG_TYPE_REF_FAULT_TYPES ) )
        {
        ...
        else if( aggTypeId.equals( Lookup.CCEI_AGG_TYPE_REF_PARTS_REPLACED ) )
        {
