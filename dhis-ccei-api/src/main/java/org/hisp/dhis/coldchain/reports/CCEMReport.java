...
public class CCEMReport
{
    ...
    public static final String CATALOGTYPE_ATTRIBUTE_VALUE_BY_WORKING_STATUS = "CATALOGTYPE_ATTRIBUTE_VALUE_BY_WORKING_STATUS";
    ...
    public static final String CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_PIE = "CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_PIE";

    public static final String CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_BAR = "CATALOGTYPE_ATTRIBUTE_VALUE_AGE_GROUP_BAR";
    ...
    public static final String SERVICE_AND_REPAIR = "SERVICE_AND_REPAIR";

    public static final String AWAITING_REPAIR = "AWAITING_REPAIR";

    public static final String PARTS_USAGE = "PARTS_USAGE";

    public static final String DAYS_WAITING_REPAIR_REPORT = "DAYS_WAITING_REPAIR_REPORT";
    
    public static final String EQUIPMENT_AGE_REPORT = "EQUIPMENT_AGE_REPORT";
    ...
    public static final String LAST_1_MONTHS = "LAST_1_MONTHS";
