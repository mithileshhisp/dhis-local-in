...
public interface CCEMReportManager
{
    ...
    Map<String, String> getDataValueMapForRequirement( String orgUnitIdsByComma, String dataelementIds, Integer periodId );
    
    // for new report
    List<OrganisationUnit> getOrgunits( List<Integer> selOrgUnitList, List<Integer> orgunitGroupList );
    
    List<OrganisationUnit> getEquipmentStatusOrgunits( String startDate, String endDate );
    
    List<Equipment> getServiceAndRepairEquipmentList( String startDate, String endDate );
    
    List<Equipment> getAwaitingRepairEquipmentList( String startDate, String endDate );
    
    Map<String, String> getModelAttributeValueForModelTypeAttributeId( String modelTypeAttributeIdsByComma );
    
    Map<String, String> getTypeCountAndMaxDateFromEquipmentStatus( String startDate, String endDate );
    
    Map<Integer, String> getPartsReplacedCount( String startDate, String endDate );
    
    Map<String, String> getTypeCountAndMaxDateFromEquipmentAwaitingRepairStatus( String startDate, String endDate, String workingStatus );
    
    Map<Integer, String> getPartsUses( String startDate, String endDate );
    
    Map<String, String> getEquipmentTypeAttributeValue( String equipmentTypeAttributeIdsByComma );
}
