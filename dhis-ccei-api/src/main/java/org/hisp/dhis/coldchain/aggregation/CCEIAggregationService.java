...
public interface CCEIAggregationService
{
    ...
    String getQueryForRefrigeratorFaultTypes( Integer equipmentTypeId, String faultTypes );
    
    String getQueryForRefrigeratorPartsReplaced( Integer equipmentTypeId, String partsReplaced );
    
    String getQueryForRefrigeratorWorkingStatus( Integer equipmentTypeId, String workingStatus );
