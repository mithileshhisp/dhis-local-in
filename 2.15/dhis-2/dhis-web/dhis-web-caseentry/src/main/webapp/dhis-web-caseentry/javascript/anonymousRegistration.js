...
function getDataElements() {
    ...
    jQuery( '[name=programStageId]').val( programStageId );
...
function searchEvents( listAll ) {
    var search = jQuery( '[name=programStageId]' ).length !=0 && jQuery( '[name=programStageId]' ).val() != "";
...
function addNewEvent() {
    ...
    var programId = $( '#programId option:selected' ).attr('puid');
