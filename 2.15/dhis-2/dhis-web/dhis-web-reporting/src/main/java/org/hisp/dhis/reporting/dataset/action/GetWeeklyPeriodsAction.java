...
public class GetWeeklyPeriodsAction implements Action
{
    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        {
            //String tempPeriodName = simpleDateFormat.format( period.getStartDate() ) + " - " + simpleDateFormat.format( period.getEndDate() );
            
            period.setName( simpleDateFormat.format( period.getStartDate() ) + " - " + simpleDateFormat.format( period.getEndDate() ) );
