    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        */
        ...
        //List<EquipmentAttributeValue> equipmentDetailsList = new ArrayList<EquipmentAttributeValue>( equipmentService.getEquipments( equipment ) );
        
        //inventryTypeAttributeAndValueMap = new HashMap<String, String>();
        
        //inventryTypeAttributeAndValueMap.putAll( equipmentService.inventryTypeAttributeAndValue( equipment, equipmentTypeAttributeList ));
       ...
       /*
        for( EquipmentTypeAttribute equipmentTypeAttribute : equipmentTypeAttributeList )
        {
            ...
            EquipmentAttributeValue equipmentAttributeValueDetails = equipmentAttributeValueService.getEquipmentAttributeValue( equipment, equipmentTypeAttribute );
       ...
       */
        ...
        {
            if ( EquipmentTypeAttribute.TYPE_COMBO.equalsIgnoreCase( equipmentAttributeValueDetails.getEquipmentTypeAttribute().getValueType() ) )
            {
                equipmentValueMap.put( equipmentDetails.getEquipmentTypeAttribute().getId(), equipmentAttributeValueDetails.getEquipmentTypeAttributeOption().getName() );
            }
            else
            {
                equipmentValueMap.put( equipmentDetails.getEquipmentTypeAttribute().getId(), equipmentAttributeValueDetails.getValue() );
            }
        }
        */
