...
function periodSelected()
{
    ...
    {    	
        ...
        {
			if( dataSetId == "zZNonMLdIHn" )
			{
				//alert( "Inside Load Value - " + dataSetId );
				loadForm();
			}
        ...
        {
			//alert( "Inside Load Form - " + dataSetId );
            loadForm();
        }
    }
}
...
/*
function getSpanMessageOnLoad()
{
	spanMessage( 'YlFSQlYp9NI-ag38TRuu23a-val' );spanMessage( 'YlFSQlYp9NI-Gieh5dgKY4i-val' );spanMessage( 'YlFSQlYp9NI-ELLNc0rTCB2-val' );
	spanMessage( 'YlFSQlYp9NI-tZDhjzKN4Fh-val' );spanMessage( 'YlFSQlYp9NI-QtVLCqXF90x-val' );spanMessage( 'YlFSQlYp9NI-lI4rsfPjPLk-val' );
	spanMessage( 'YlFSQlYp9NI-nf5jymXvIyj-val' );spanMessage( 'YlFSQlYp9NI-CxL7A9gInsp-val' );spanMessage( 'YlFSQlYp9NI-VvOickOZl7r-val' );
	
	
	var myStringArray = ['YlFSQlYp9NI-ag38TRuu23a-val','YlFSQlYp9NI-Gieh5dgKY4i-val','YlFSQlYp9NI-ELLNc0rTCB2-val',
						 'YlFSQlYp9NI-tZDhjzKN4Fh-val','YlFSQlYp9NI-QtVLCqXF90x-val','YlFSQlYp9NI-lI4rsfPjPLk-val',
						 'YlFSQlYp9NI-nf5jymXvIyj-val','YlFSQlYp9NI-CxL7A9gInsp-val','YlFSQlYp9NI-VvOickOZl7r-val',
						 'LDmxWcmyQBv-ag38TRuu23a-val','LDmxWcmyQBv-Gieh5dgKY4i-val','LDmxWcmyQBv-ELLNc0rTCB2-val',
						 'LDmxWcmyQBv-tZDhjzKN4Fh-val','LDmxWcmyQBv-QtVLCqXF90x-val','LDmxWcmyQBv-lI4rsfPjPLk-val',
						 'LDmxWcmyQBv-nf5jymXvIyj-val','LDmxWcmyQBv-CxL7A9gInsp-val','LDmxWcmyQBv-VvOickOZl7r-val',
						 'vHLUrrfPUER-ag38TRuu23a-val','vHLUrrfPUER-Gieh5dgKY4i-val','vHLUrrfPUER-ELLNc0rTCB2-val',
						 'vHLUrrfPUER-tZDhjzKN4Fh-val','vHLUrrfPUER-QtVLCqXF90x-val','vHLUrrfPUER-lI4rsfPjPLk-val',
						 'vHLUrrfPUER-nf5jymXvIyj-val','vHLUrrfPUER-CxL7A9gInsp-val','vHLUrrfPUER-VvOickOZl7r-val',
						 'YzGwdCfEhjy-ag38TRuu23a-val','YzGwdCfEhjy-Gieh5dgKY4i-val','YzGwdCfEhjy-ELLNc0rTCB2-val',
						 'YzGwdCfEhjy-tZDhjzKN4Fh-val','YzGwdCfEhjy-QtVLCqXF90x-val','YzGwdCfEhjy-lI4rsfPjPLk-val',
						 'YzGwdCfEhjy-nf5jymXvIyj-val','YzGwdCfEhjy-CxL7A9gInsp-val','YzGwdCfEhjy-VvOickOZl7r-val',
